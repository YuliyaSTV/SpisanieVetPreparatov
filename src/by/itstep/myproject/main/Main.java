...
public class Main {
	...
	public static void main(String[] args) {
		...
		Product product2 = new Product(GroupOfDrug.ANTIBIOTIC, "Гентамокс", "ЖКТ", "гентамицин + амоксициллин", 100, 10,
				"мл", "1мл/10кг");
		Product product16 = new Product(GroupOfDrug.ANTIPARASITIC, "Альбендазол", "противогельминтные", "альбендазол",
				100, 10, "гр", "10мл/10кг");
		Product product15 = new Product(GroupOfDrug.ANTIPARASITIC, "Мерадок", "против эктопаразитов", "doramectin", 100,
				10, "мл", "10мл/10кг");
		Product product13 = new Product(GroupOfDrug.NPVS, "Ainil", "противовосполительное", "кетопрофен", 100, 10, "мл",
				"3мл/10кг");
		Product product12 = new Product(GroupOfDrug.NPVS, "Ketoprofen", "антипиретик", "кетопрофен", 100, 10, "мл",
				"3мл/10кг");
		...
		Product product11 = new Product(GroupOfDrug.ANTIBIOTIC, "Марбоцил 10%", "жкт", "марбофлоксацин", 100, 10, "мл",
				"1мл/10кг");
		Product product5 = new Product(GroupOfDrug.ANTIBIOTIC, "Гентаприм", "жкт", "гентамицин + сульфадиметоксин", 100,
				10, "мл", "10мл/10кг");
		Product product6 = new Product(GroupOfDrug.ANTIBIOTIC, "Лексофлон", "респираторный тракт", "левофлоксацин", 100,
				10, "мл", "1мл/10кг");
		Product product14 = new Product(GroupOfDrug.ANTIBIOTIC, "Микогал", "жкт", "спирамицина адипат", 100, 10, "мл",
				"1мл/10кг");
		Product product3 = new Product(GroupOfDrug.ANTIBIOTIC, "Нитокс 200", "широкий спектр", "окситетрациклин", 100,
				10, "мл", "1мл/10кг");
		Product product4 = new Product(GroupOfDrug.ANTIBIOTIC, "Ресфлор", "респираторный тракт",
				"флорфеникол + флуниксин ", 100, 10, "мл", "2мл/10кг");
		Product product17 = new Product(GroupOfDrug.ANTIPARASITIC, "Галокур", "криптоспоридиоз", "галофугинон", 500, 4,
				"мл", "2мл/10кг");
		Product product18 = new Product(GroupOfDrug.ANTIPARASITIC, "Ивермек", "стронгиляты", "ивермектин", 100, 10,
				"мл", "1мл/10кг");
		Product product19 = new Product(GroupOfDrug.ANTIPARASITIC, "Левамизол 8%", "нематоды", "левамизол", 100, 10,
				"гр", "10мл/10кг");
		Product product20 = new Product(GroupOfDrug.ANTIPARASITIC, "Larvenol", "яйца и личинки насекомых",
				"этофенпрокс", 1000, 5, "мл", "200мл/10кг");
